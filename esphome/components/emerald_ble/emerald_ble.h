...
static const float h_to_s_conversion = 3600.0;    // conversion ratio hours to seconds
...
class Emerald : public esphome::ble_client::BLEClientNode, public Component {
 ...
 public:
  ...
  void set_pulses_per_kwh(uint16_t pulses_per_kwh) {
    ...
    pulse_multiplier_ = (kw_to_w_conversion * h_to_s_conversion) / (pulses_per_kwh * standard_update_interval);
  }
